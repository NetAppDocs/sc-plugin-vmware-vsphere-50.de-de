...
+
Sie müssen das Windows PowerShell Cmdlet für jede Instanz des SnapCenter VMware Plug-ins verwenden `invoke-SCVOVAMigration` , das mit SnapCenter registriert ist.
