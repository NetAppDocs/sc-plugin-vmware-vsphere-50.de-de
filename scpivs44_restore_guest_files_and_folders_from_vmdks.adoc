...
+
In der Tabelle Guest Session Monitor können Sie zusätzliche Informationen zu einer Sitzung anzeigen, indem Sie auf *... klicken. *In der rechten Spalte.
...
+
Um das Durchsuchen zu vereinfachen, können Sie Filter in Ihrer Suchzeichenfolge verwenden. Bei den Filtern handelt es sich um Groß- und Kleinschreibung-Perlausdrücke ohne Leerzeichen. Die Standard-Suchzeichenfolge lautet `.`*. Die folgende Tabelle zeigt ein Beispiel für Perl-Suchausdrücke.
