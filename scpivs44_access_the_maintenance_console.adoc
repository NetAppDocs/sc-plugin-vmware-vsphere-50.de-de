...
+ IP-Adresseinstellungen anzeigen oder ändern Sucheinstellungen für Domänennamen anzeigen oder ändern statische Routen anzeigen Änderungen bestätigen Ping an einen Host

+ * Option 4: Support und Diagnose

+ Generate Support Bundle Access Diagnostic Shell enable Remote Diagnostic Access Generate Core Dump Bundle
