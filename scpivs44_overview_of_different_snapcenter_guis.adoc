...
| GUI von SnapCenter | Backup und Restore von Datenbanken und Applikationen auf VMs, einschließlich der Sicherung von Datenbanken für Microsoft SQL Server, Microsoft Exchange und Oracle. Datenbankklone | Backups werden über die GUI von SnapCenter durchgeführt. 
